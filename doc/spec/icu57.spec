...
%endif
./configure --prefix=%{icu_prefix} $OPTIONS
...
chmod +x $RPM_BUILD_ROOT%{icu_prefix}/lib/*.so.*
# (
#  cd $RPM_BUILD_ROOT%{icu_prefix}/bin
#  mv icu-config icu-config-%{__isa_bits}
# )
# install -p -m755 -D %{SOURCE1} $RPM_BUILD_ROOT%{icu_prefix}/bin/icu-config
